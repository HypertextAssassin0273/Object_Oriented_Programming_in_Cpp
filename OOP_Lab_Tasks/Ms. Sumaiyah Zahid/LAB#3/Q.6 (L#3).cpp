...
public:
	...
	Vehicle(){ year=0,speed=0,isUsed=0,X=0; } // default c'tor
	
//	Vehicle():year(0),speed(0),isUsed(0),X(0){} // initialzier list c'tor
	
//	Vehicle(int year,int speed){ // parameterized c'tor
//		this->year=year;
//		this->speed=speed;
//		this->X=0;
//	}
	
//	Vehicle(int year=0,int speed=0){ // default parameterized c'tor
//		this->year=year;
//		this->speed=speed;
//		this->X=0;
//	}
